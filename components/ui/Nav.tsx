...
const linkHrefs = ['/versus', '/teams', '/mc', '/groups', '/knockout/r32', '/my-bracket', '/stats', '/live', '/about'] as const
const linkKeys = ['versus', 'teams', 'mc', 'groups', 'bracket', 'myBracket', 'stats', 'live', 'about'] as const
